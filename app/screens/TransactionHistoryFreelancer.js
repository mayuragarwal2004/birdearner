...
const TransactionHistoryFreelancerScreen = ({ navigation }) => {
  ...
  const fetchTransactionHistory = async () => {
    try {
      ...
      console.error("Error fetching freelancer transaction history:", error);
            ...
            {walletSnapshot && (
              <View style={styles.topOverviewCard}>
                <View style={styles.topOverviewRow}>
                  <View>
                    <Text style={styles.topOverviewLabel}>Withdrawable Balance</Text>
                    <Text style={styles.topOverviewValue}>
                      ₹{Number(walletSnapshot.wallet || 0).toFixed(2)}
                    </Text>
                  </View>
                  <View style={{ alignItems: "flex-end" }}>
                    <Text style={styles.topOverviewLabel}>Total Earnings</Text>
                    <Text style={[styles.topOverviewValue, { color: "#4CAF50" }]}>
                      ₹{Number(walletSnapshot.totalEarnings || 0).toFixed(2)}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              {selectedTx && (
                <ScrollView style={{ maxHeight: 400 }}>
                  ...
                  <View style={styles.snapshotBox}>
                    ...
                    <View style={styles.snapshotRow}>
                      <Text style={styles.snapshotLabel}>Transaction Amount:</Text>
